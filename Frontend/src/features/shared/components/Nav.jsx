...
const Nav = () => {
  ...
  const navLinkClass =
    "relative py-1 transition-colors duration-300 hover:text-[#C9A96E] after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:h-[1px] after:w-0 after:bg-[#C9A96E] after:transition-all after:duration-300 hover:after:w-full hover:after:left-0";
    ...
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-500 ${
        scrolled
          ...
          : "bg-transparent border-b border-[#e4e2df]/60"
      }`}
    >
          ...
          {user ? (
            <>
              ...
              <a
                ...
                className="text-xs font-medium uppercase tracking-widest text-gray-900 hover:text-[#C9A96E] transition-colors duration-300"
              >
                Logout
              </a>
            </>
            ...
            <div className="flex items-center gap-6">
              ...
              <Link
                to="/register"
                className="border border-[#1b1c1a] px-5 py-2.5 hover:bg-[#1b1c1a] hover:text-white transition-all duration-300"
              >
                Sign Up
              </Link>
            </div>
