          ...
          <div className="flex items-center gap-12 border-l border-neutral-100 pl-12 lg:flex">
            <div>
              ...
              <p className="text-2xl font-serif">
                ...
                <span className="text-sm font-sans text-neutral-400 uppercase">
                  Units
                </span>
              </p>
            </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-8 py-16">
        <div className="flex items-center justify-between mb-12">
          ...
          <span className="text-[11px] font-serif italic text-neutral-400">
            Showing {sellerProducts?.length || 0} items
          </span>
        </div>
        ...
        {sellerProducts && sellerProducts.length > 0 ? (
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center">
            <h2 className="text-4xl font-serif italic text-neutral-300 mb-4 font-light">
              Your vault is currently empty.
            </h2>
            <p className="text-neutral-400 text-xs uppercase tracking-widest mb-8">
              Ready to showcase your first masterpiece?
            </p>
            <button
              onClick={() => navigate("/seller/create-product")}
