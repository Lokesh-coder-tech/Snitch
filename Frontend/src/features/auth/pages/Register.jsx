      ...
      <div className="flex w-full h-screen">
        ...
        <div className="hidden lg:block lg:w-1/2 relative overflow-hidden bg-[#f4f4f4]">
          ...
          <div className="absolute bottom-12 left-12 right-12 border border-white/30 backdrop-blur-md p-8 text-white">
            <p className="text-[10px] tracking-[0.4em] uppercase mb-2 text-white/80">
              Membership
            </p>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-3 py-2">
                ...
                <label
                  htmlFor="isSeller"
                  className="text-xs text-neutral-500 uppercase tracking-widest cursor-pointer select-none"
                >
                  Register as Seller
                </label>
              </div>
              ...
              <div className="pt-6 flex flex-col gap-6">
                ...
                <p className="text-center text-[10px] uppercase tracking-widest text-neutral-400">
                  ...
                  <Link
                    to="/login"
                    className="ml-2 font-bold text-black border-b border-black pb-0.5 hover:text-neutral-500 hover:border-neutral-500 transition-colors"
                  >
                    SIGN IN
                  </Link>
                </p>
